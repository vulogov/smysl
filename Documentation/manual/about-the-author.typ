...
exists. It carries no analytics, no telemetry, no upsell. Twenty-three of its
twenty-five commands cannot open a socket at all, and the two that can will tell
