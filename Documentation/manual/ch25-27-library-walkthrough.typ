...
#dtable(
  ...
  (
    ...
    ([`ingest`], [`stage`, `providers` and `smysl-ingest/model` — `Ingestor` and `attest`, which call a model. Until 1.3 this was the only way to get staging, and it brought the provider layer along.]),
